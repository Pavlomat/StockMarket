...
class ViewController: UITableViewController, UISearchBarDelegate, UISearchResultsUpdating {
    ...
    override func viewDidLoad() {
        ...
        // тк апи взяты с бесплатного сайта то есть ограничение на 100 запросов в месяц, на api pavlov осталось 70 запросов.
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if tabBarController?.selectedIndex == 0 {
            ...
            //formatNumber() функция для округления данных с апи
            ...
            cell.longName.text = share.longName
            cell.symbol.text = share.symbol
            cell.price.text = String(share.regularMarketPrice!)
